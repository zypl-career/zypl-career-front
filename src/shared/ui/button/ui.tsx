    ...
    variants: {
      variant: {
        ...
        status:
          ...
          login:
              'border border-[#9CA3AF] text-[#4B5563] w-full bg-background font-[600] hover:text-accent-foreground rounded-2xl w-full transform transition-transform duration-200 active:scale-110',
        outlineSecondary:
