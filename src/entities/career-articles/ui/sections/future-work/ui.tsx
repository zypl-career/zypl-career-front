...
import { FutureWorkImg } from '@/shared';

export const FutureWork = () => {
  return (
    <div className="flex flex-col md:flex-row items-center px-6 md:px-24">
      <Image
        src={FutureWorkImg}
        alt="future-work"
        width={400}
      ...
      <div className="text-center md:text-left">
        ...
        <h2 className="text-2xl font-bold mt-2">Будущее работы</h2>
        <p className="mt-2">
