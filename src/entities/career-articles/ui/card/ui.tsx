...
export const MoreCardCareerArticles: FC<TMoreCardProps> = ({
  ...
  return (
    <div className="bg-white border border-gray-100 shadow-lg rounded-xl transition-transform transform duration-300 ease-in-out hover:scale-105 hover:shadow-2xl cursor-pointer my-5">
      <Image
        src={imageSrc}
        alt={imageAlt}
        height={imageHeight}
