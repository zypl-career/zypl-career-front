export const LABELS_QUESTION = [
  'Official / Registered Employee (NOT YOUR FAMILY BUSINESS)',
  'Unofficial / unregistered employee (NOT YOUR FAMILY BUSINESS)',
  'Working as an employee or assistant in a NON-agricultural business',
  'Work as an employee or assistant on a farm',
  'Entrepreneur / employee with self-account / private entrepreneur / employer',
